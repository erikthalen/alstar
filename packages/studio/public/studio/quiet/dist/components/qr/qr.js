...
(function(w) {
  ...
  function C(t2, c, a, e2, b, h, r, d, g, x2) {
    function u(b2, a2, f, c2, d2, r2, g2) {
      b2 ? (t2.lineTo(a2 + r2, f + g2), t2.arcTo(a2, f, c2, d2, h)) : t2.lineTo(a2, f);
    }
    r ? t2.moveTo(c + h, a) : t2.moveTo(c, a);
    u(d, e2, a, e2, b, -h, 0);
    u(g, e2, b, c, b, 0, -h);
    u(x2, c, b, c, a, h, 0);
    u(r, c, a, e2, a, 0, h);
  }
  function z(t2, c, a, e2, b, h, r, d, g, x2) {
  ...
  function A(t2, c) {
    var a = c.fill;
    if ("string" === typeof a) t2.fillStyle = a;
    else {
      var e2 = a.type, b = a.colorStops;
      a = a.position.map((b2) => Math.round(b2 * c.size));
      if ("linear-gradient" === e2) var h = t2.createLinearGradient.apply(t2, a);
      else if ("radial-gradient" === e2) h = t2.createRadialGradient.apply(t2, a);
  ...
  G = function(t2, c) {
    ...
    if (c instanceof HTMLCanvasElement) {
      ...
      y(c, a);
    } else t2 = document.createElement("canvas"), t2.width = a.size, t2.height = a.size, a = y(t2, a), c.appendChild(a);
  };
})(function() {
  function w(c) {
    var a = C.s(c);
  ...
  var A = { L: 1, M: 0, Q: 3, H: 2 }, y = /* @__PURE__ */ function() {
    ...
    var a = [
      ...
      for (var a2 = b.h(), c2 = 0, d = 0; d < a2; d += 1) for (var g = 0; g < a2; g += 1) {
        for (var e3 = 0, t3 = b.a(d, g), p = -1; 1 >= p; p += 1) if (!(0 > d + p || a2 <= d + p)) for (var q = -1; 1 >= q; q += 1) 0 > g + q || a2 <= g + q || (0 != p || 0 != q) && t3 == b.a(d + p, g + q) && (e3 += 1);
        5 < e3 && (c2 += 3 + e3 - 5);
      }
    ...
    var a = [
      ...
      b = e3.length / 3;
      a2 = [];
      for (var d = 0; d < b; d += 1) for (var g = e3[3 * d], h = e3[3 * d + 1], t3 = e3[3 * d + 2], p = 0; p < g; p += 1) {
        var q = t3, f = {};
        f.o = h;
        f.j = q;
        a2.push(f);
...
// src/components/qr/qr.ts
var QuietQr = class extends QuietElement {
  constructor() {
    super(...arguments);
    this.data = "";
    this.label = "";
  ...
  updated(changedProperties) {
    if (changedProperties.has("data") || changedProperties.has("errorCorrection") || changedProperties.has("corners") || changedProperties.has("size")) {
      this.draw();
    }
    ...
    qr_creator_es6_min_default.render(
      {
        ...
        fill: getComputedStyle(this).color,
        // get the current text color
        background: null,
        // always transparent; set background-color on the host element instead
        size: this.size * 2
        // we double the size so it's not blurry on high pixel density devices
      },
      this.canvas
    );
  }
  render() {
    return x`<canvas aria-hidden="true" @transitionend=${() => this.draw()}></canvas>`;
  }
};
QuietQr.styles = [host_styles_default, qr_styles_default];
__decorateClass([
  e("canvas")
], QuietQr.prototype, "canvas", 2);
__decorateClass([
  n()
], QuietQr.prototype, "data", 2);
__decorateClass([
  n()
], QuietQr.prototype, "label", 2);
__decorateClass([
  n({ attribute: "error-correction" })
], QuietQr.prototype, "errorCorrection", 2);
__decorateClass([
  n({ type: Number })
], QuietQr.prototype, "corners", 2);
__decorateClass([
  n({ type: Number })
], QuietQr.prototype, "size", 2);
QuietQr = __decorateClass([
  t("quiet-qr")
], QuietQr);
export {
  QuietQr
